...
; entries correspond to FRUITTREE_* constants
	...
	db BERRY        ; ROUTE_37_1
	db BERRY        ; ROUTE_37_2
	db MYSTERYBERRY ; ROUTE_37_3
	db BURNT_BERRY ; AZALEA_TOWN
	db MIRACLEBERRY ; ROUTE_42_1
	db MIRACLEBERRY ; ROUTE_42_2
	db MIRACLEBERRY ; ROUTE_42_3
	db BERRY        ; ROUTE_11
