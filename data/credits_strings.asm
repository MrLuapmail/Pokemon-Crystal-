...
; entries correspond to constants/credits_constants.asm
	...
	dw .CrystalKaizoDev
	dw .CrystalKaizoPlus
	dw .CKKProjectManagement
	dw .Luapmail
	dw .CKKAsstProjectManagement
	dw .Mannat
	dw .CKKLeadProgrammer
	dw .KDLPro 
	dw .CKKProgrammers
	dw .Xavion
	dw .Dekzeh
	...
	dw .Maril300
	dw .Silvion
	dw .CKKGameTestersTheorys
	dw .QuestionableSpecimen
	dw .Refinery
	dw .Reje
	dw .Runabun
	dw .Safetyman
...
.CrystalKaizo:		 	   db " CRYSTAL KAIZO DEV@"
.CrystalKaizoDev:	 	   db "SinisterHoodedFigure@"
.CrystalKaizoPlus:	 	   db "      #MON"                 
					     next " CRYSTAL KAIZO PLUS"          
					     next "       STAFF@"
.CKKProjectManagement:	   db " PROJECT MANAGEMENT@"
.Luapmail:				   db "	    Luapmail@"
.CKKAsstProjectManagement: db "  ASSISTANT PROJECT"        
						 next "    MANAGEMENT@"
.Mannat 				   db "		  Mannat@"
.CKKLeadProgrammer:		   db "   LEAD PROGRAMMER@"
.KDLPro:				   db "       KDLPro@"
.CKKProgrammers:		   db "    PROGRAMMERS@"
.Xavion:				   db "       Xavion@"
.Dekzeh:				   db "       dekzeh@"
.NotSuicuu:				   db "     Not Suicuu@"
.Zuils:					   db "       zuils@"
.Maril300:				   db "      maril300@"
.Silvion:				   db "      Silvion@"
.CKKGameTestersTheorys:	   db "  GAME TESTERS AND"    
						 next "   THEORYCRAFTERS@" 
.QuestionableSpecimen:	   db "    Questionable"
						 next "      Specimen@"
...
.CKKSpecialThanks:		   db "  SPECIAL THANKS TO@"
.PChal:					   db "  PokémonChallenges@"
.FarewellMsg1:			   db "  In behalf of the"
						 next "  devs, I hope you"
						 next " enjoy this romhack"
						 next " as much as we enjoy"
						 next "     making it."
.FarewellMsg2:			   db "Thanks for playing!"
						 next "           "
						 next "          -KDLPro@"
