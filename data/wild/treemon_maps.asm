...
TreeMonMaps:
	...
	treemon_map ROUTE_28,                  TREEMON_SET_TOWN
	...
	treemon_map ROUTE_40,                  TREEMON_SET_TOWN
	treemon_map ROUTE_41,                  TREEMON_SET_TOWN
	...
	treemon_map SILVER_CAVE_OUTSIDE,       TREEMON_SET_TOWN
