...
TreeMonMaps:
	...
	treemon_map ROUTE_32, TREEMON_SET_TOWN
	...
	treemon_map ROUTE_43, TREEMON_SET_TOWN
	...
	treemon_map LAKE_OF_RAGE, TREEMON_SET_TOWN
	...
	treemon_map BATTLE_TOWER_OUTSIDE, TREEMON_SET_ROUTE
	db -1
