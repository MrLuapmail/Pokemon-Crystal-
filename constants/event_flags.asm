...
; HMs (EVENT_GOT_HM07_WATERFALL is with the Johto itemballs)
	...
	const EVENT_GOT_PSYCHIC ; unused
; Rods
...
; Johto story events
	...
	const EVENT_DISABLE_POCKET_PC
	const EVENT_GOT_HYPER_BEAM
...
; Johto hidden items
	...
	const EVENT_GOT_GAMECORNER_FIRE_BLAST 
	const EVENT_GOT_GAMECORNER_BLIZZARD
	const EVENT_GOT_GAMECORNER_THUNDER
	const EVENT_GOT_FIRE_BLAST 
	const EVENT_GOT_BLIZZARD  
	const EVENT_GOT_THUNDER   
...
; Phone events
	...
	const EVENT_GOT_GAMECORNER_PSYCHIC
	const EVENT_BEVERLY_ASKED_FOR_PHONE_NUMBER
	const EVENT_GOT_GAMECORNER_DOUBLE_TEAM
	const EVENT_HUEY_ASKED_FOR_PHONE_NUMBER
	const EVENT_GOT_GAMECORNER_HYPER_BEAM
	...
	const EVENT_GOLDENROD_DEPT_STORE_TM27_RETURN
