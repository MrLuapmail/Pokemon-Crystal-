...
Route2_MapEvents:
	...
	warp_event  7, 51, ROUTE_2_GATE, 3
	warp_event  8, 47, ROUTE_2_GATE, 1
	warp_event  9, 47, ROUTE_2_GATE, 2
	warp_event 12,  7, DIGLETTS_CAVE, 3

	def_coord_events

	def_bg_events
	bg_event  9, 45, BGEVENT_READ, Route2Sign
	...
	def_object_events
	object_event  6,  1, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 3, TrainerBugCatcherRob, -1
	object_event  6,  4, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 3, TrainerBugCatcherEd, -1
	...
	object_event 19, 42, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route2Elixer, EVENT_ROUTE_2_ELIXER
	object_event 10, 13, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route2FruitTree, -1
