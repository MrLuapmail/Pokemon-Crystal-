...
Route46_MapEvents:
	...
	warp_event  6, 11, DARK_CAVE_VIOLET_ENTRANCE, 3
	...
	object_event 15, 13, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route46XSpeed, EVENT_ROUTE_46_X_SPEED
