...
CeladonCity_MapEvents:
	...
	warp_event 16,  1, CELADON_MANSION_1F, 3
	warp_event 17,  1, CELADON_MANSION_1F, 3
	...
	object_event 10, 13, SPRITE_TEACHER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, CeladonCityTeacher2Script, -1
