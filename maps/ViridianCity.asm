...
ViridianCity_MapEvents:
	...
	warp_event 30, 25, TRAINER_HOUSE_1F, 1
	warp_event 19, 25, VIRIDIAN_MART, 2
	...
	bg_event 31, 27, BGEVENT_READ, TrainerHouseSign
	bg_event 24, 25, BGEVENT_READ, ViridianCityPokecenterSign
	bg_event 20, 25, BGEVENT_READ, ViridianCityMartSign
	...
	object_event  6, 13, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, ViridianCityDreamEaterFisher, -1
