...
LakeOfRage_MapEvents:
	...
	object_event 36,  6, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 1, TrainerCooltrainerfLois, EVENT_LAKE_OF_RAGE_CIVILIANS
