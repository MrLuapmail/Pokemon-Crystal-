...
RockTunnel1FHiddenXAccuracy:
	hiddenitem NUGGET, EVENT_ROCK_TUNNEL_1F_HIDDEN_X_ACCURACY
...
RockTunnel1F_MapEvents:
	...
	def_object_events
	object_event  7, 26, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RockTunnel1FElixer, EVENT_ROCK_TUNNEL_1F_ELIXER
	object_event 23, 21, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RockTunnel1FTMSteelWing, EVENT_ROCK_TUNNEL_1F_TM_STEEL_WING
